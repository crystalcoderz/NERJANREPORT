...
async function geocode(query: string): Promise<GeoResult | null> {
  try {
    ...
    console.log("location-brief geocode failed:", (err as Error).message)
    return null
  }
}
...
async function fetchWeather(lat: number, lng: number): Promise<LiveWeather> {
  try {
    ...
    console.log("location-brief weather fetch failed:", (err as Error).message)
...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.log("location-brief Gemini failed, trying Kimi:", (geminiError as Error).message)
    try {
      ...
      console.log("location-brief Kimi failed:", (kimiError as Error).message)
